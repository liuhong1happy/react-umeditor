...
var SpecialCharsDialog = function (_React$Component) {
	_inherits(SpecialCharsDialog, _React$Component);

	function SpecialCharsDialog(props) {
		_classCallCheck(this, SpecialCharsDialog);

		var _this = _possibleConstructorReturn(this, (SpecialCharsDialog.__proto__ || Object.getPrototypeOf(SpecialCharsDialog)).call(this, props));
