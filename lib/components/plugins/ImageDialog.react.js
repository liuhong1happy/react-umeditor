...
var ImageDialog = function (_React$Component) {
	...
	_createClass(ImageDialog, [{
		...
		value: function render() {
			...
			var tabs = [{ title: "本地上传", component: React.createElement(_ImageUpload2.default, {
					ref: 'image',
					...
					name: uploader.name,
					url: uploader.url,
					qiniu: uploader.qiniu }) }, { title: "网络图片", component: React.createElement(_ImageSearch2.default, {
					ref: 'image',
					onChange: this.handleChange.bind(this)
				}) }];
