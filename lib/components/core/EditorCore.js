...
var _EditorToolbar = require('../core/EditorToolbar');

var _EditorToolbar2 = _interopRequireDefault(_EditorToolbar);

var _EditorTextArea = require('../core/EditorTextArea');

var _EditorTextArea2 = _interopRequireDefault(_EditorTextArea);

var _EditorContentEditableDiv = require('../core/EditorContentEditableDiv');
...
var EditorCore = function (_Component) {
  ...
  function EditorCore(props) {
    ...
    _this.editorForeColor = function (offsetPosition, editarea) {
      _EditorSelection2.default.storeRange();
    ...
    _this.editorBackColor = function (offsetPosition, editarea) {
      _EditorSelection2.default.storeRange();
      offsetPosition.y += offsetPosition.h + 5;
    ...
    _this.editorFontSize = function (offsetPosition, editarea) {
      _EditorSelection2.default.storeRange();
      offsetPosition.y += offsetPosition.h + 5;
    ...
    _this.editorFontFamily = function (offsetPosition, editarea) {
      _EditorSelection2.default.storeRange();
      offsetPosition.y += offsetPosition.h + 5;
    ...
    _this.editorParagraph = function (offsetPosition, editarea) {
      _EditorSelection2.default.storeRange();
      offsetPosition.y += offsetPosition.h + 5;
    ...
    value: function handleToolbarIconClick(e, state) {
      ...
      switch (state.icon) {
        ...
        case "emotion":
          ...
          break;
        default:
          var pIcons = this.props.plugins.toolbar.icons || [];
          var fIcon = pIcons.find(function (ic) {
            return ic.name === state.icon;
          });
          if (fIcon && fIcon.onHandle) fIcon.onHandle({
            editarea: editarea,
            root: root,
