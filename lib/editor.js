...
var Editor = React.createClass({
	...
	genEditArea: function genEditArea() {
		...
		if (showHtml) {
			return React.createElement(EditorTextArea, { ref: 'editarea', onFocus: this.handleFocus });
		} else {
			return React.createElement(EditorContentEditableDiv, { ref: 'editarea', onRangeChange: this.handleRangeChange, onFocus: this.handleFocus });
		}
	},
